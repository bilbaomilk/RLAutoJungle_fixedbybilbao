...
Price = 1337,
needItem = ItemId.Rangers_Trailblazer,
item = ItemId.The_Brutalizer,
index = 2
},
new ItemToShop()
{
Price = 100,
needItem = ItemId.The_Brutalizer,
item = ItemId.Rangers_Trailblazer_Enchantment_Warrior,
index = 3
},
new ItemToShop()
{
Price = 325,
needItem = ItemId.Rangers_Trailblazer_Enchantment_Warrior,
...
item = ItemId.Spectres_Cowl,
index = 8
},
new ItemToShop()
{
Price = 1700,
needItem = ItemId.Spectres_Cowl,
item = ItemId.Spirit_Visage,
index = 9
},
new ItemToShop()
{
Price = 1900,
needItem = ItemId.Spirit_Visage,
...
index = 14
    ...
    private static void Game_OnGameLoad(EventArgs args)
    {
        ...
        RLProjectAutoJungleMenu.AddItem(new MenuItem("maxstacks", "Max Stacks").SetValue(new Slider(150, 1, 150)));
        RLProjectAutoJungleMenu.AddItem(new MenuItem("maxlv", "Max level").SetValue(new Slider(18, 1, 18)));
        RLProjectAutoJungleMenu.AddItem(new MenuItem("autorecallheal", "Recall[for heal]")).SetValue(true);
        RLProjectAutoJungleMenu.AddItem(new MenuItem("hpper", "Recall on HP(%)").SetValue(new Slider(35, 0, 100)));
        ...
        RLProjectAutoJungleMenu.AddItem(new MenuItem("k_dragon", "Add Dragon to Route on Lv").SetValue(new Slider(15, 1, 18)));
    ...
    int level = Player.Level;    
        ...
        if (!IsOVER)
        {
            ...
            if (IsStart) // start
            {
                ...
                {
                    if(Items.HasItem((int)(ItemId.Warding_Totem_Trinket)))
                    {
